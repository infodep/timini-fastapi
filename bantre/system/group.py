...
groups_sections = Table('groups_sections',
    Base.metadata,
...
class GroupModel(Base):
    ...
    sections_permissions = relationship('SectionModel', secondary=groups_sections,\
        back_populates = 'groups_permissions', lazy='dynamic')
